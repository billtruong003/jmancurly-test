namespace Fusion
{
  ...
  public class FusionBootstrap : Fusion.Behaviour
  {
    ...
    public static event Action OnNetworkStarted;
      ...
      INetworkRunnerUpdater updater = null)
    {
      ...
      return runner.StartGame(new StartGameArgs
      {
        ...
        {
          // Thêm callback OnGameStarted**
          onGameStarted?.Invoke(runner); // Gọi callback gốc nếu có**
          OnNetworkStarted?.Invoke(); // Gọi sự kiện OnNetworkStarted**
        },
