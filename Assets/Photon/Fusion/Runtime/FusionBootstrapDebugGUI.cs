namespace Fusion
{
  ...
  public class FusionBootstrapDebugGUI : Fusion.Behaviour
  {
    ...
    protected virtual void OnGUI()
    {
      ...
      float rightAlignedX = Screen.width - width - rightMargin;

      float verticalOffset = 30f;
      float topMarginY = margin + verticalOffset;


      GUILayout.BeginArea(new Rect(rightAlignedX, topMarginY, width, Screen.height)); // Sử dụng adjustedMarginY
      {
